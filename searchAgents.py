...
def foodHeuristic(state, problem):
    ...
    # Calcular la distancia Manhattan a todas las comidas
    # y devolver la máxima como heurística admisible
    distances = []
    for food in foodList:
        manhattanDist = abs(position[0] - food[0]) + abs(position[1] - food[1])
        distances.append(manhattanDist)
    
    # Retornamos la máxima distancia como heurística
